function [coordix, coordiy, coorditheta] = Scheduler(robots)
clc;
clear all;
...
save('Parameter','binaryImage','gx','gy','Rangeconstant','max_value','L_range','RGB','RGB2','POI','unique_all_vertex_base');
