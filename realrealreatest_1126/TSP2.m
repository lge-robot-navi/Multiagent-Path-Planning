function shortestPath=TSP2(dmat,unique_all_vertex,Debug_Plot)
figure(2)

nStops = size(unique_all_vertex,1); % you can use any number, but the problem size scales as N^2
stopsLon = unique_all_vertex(:,1);
stopsLat = unique_all_vertex(:,2);
